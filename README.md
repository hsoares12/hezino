...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create hezino-d7bd
  fly apps create hezino-d7bd-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app hezino-d7bd
  ...
  >
  > ```
  > WARN app flag 'hezino-d7bd-staging' does not match app name in config file 'hezino-d7bd'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name hezino-d7bd-db
  fly postgres attach --app hezino-d7bd hezino-d7bd-db

  fly postgres create --name hezino-d7bd-staging-db
  fly postgres attach --app hezino-d7bd-staging hezino-d7bd-staging-db
  ```
